...
- [DEMO LINK](https://sadeni-09.github.io/layout_moyo-header-en/)
- [TEST REPORT LINK](https://sadeni-09.github.io/layout_moyo-header-en/report/html_report/)
...
## The task
Create HTML page with the header using `flexbox` basing on [this mockup](https://www.figma.com/file/1sog2rmfyCjnVxkeZ3ptnc/MOYO-%2F-Header?type=design&node-id=0-1&t=uC86JBltA206qBlc-0).
